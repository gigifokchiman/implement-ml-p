...
resource "aws_iam_role_policy_attachment" "node_group_AmazonEFSCSIDriverPolicy" {
  policy_arn = "arn:aws:iam::aws:policy/service-role/AmazonEFSCSIDriverPolicy"
  role       = aws_iam_role.node_group.name
}

# Custom policy for enhanced node group permissions
...
# IRSA (IAM Roles for Service Accounts) roles
...
resource "aws_iam_role_policy_attachment" "irsa_aws_load_balancer_controller" {
...
resource "aws_iam_role_policy_attachment" "irsa_ebs_csi_driver" {
  policy_arn = "arn:aws:iam::aws:policy/service-role/AmazonEBSCSIDriverPolicy"
...
resource "aws_iam_role_policy_attachment" "irsa_efs_csi_driver" {
  policy_arn = "arn:aws:iam::aws:policy/service-role/AmazonEFSCSIDriverPolicy"
  role       = aws_iam_role.irsa_efs_csi_driver.name
}
...
resource "aws_iam_role_policy" "irsa_cluster_autoscaler" {
